...
import "./AgentMilkCollectionCycleList.scss";
    ...
    items?.push({
      ...
      heading_2: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Link
            to={isddSelected ? `/agent-collection-report` : null}
            style={{
          ...
          >
            ...
            >
              Generate Agent-Wise Milk Collection Report
            </span>
          </Link>
        </div>
      ),
    ...
    shiftWiseItems.push(
      {
        heading_2: (
          <div style={{ display: "flex", flexDirection: "column" }}>
            <Link
              to={(startDate !== null && endDate !== null && shift !== null) ? `/agent-collection-report` : null}
              style={{
          ...
          <div className="reconcillation__header">
            <div className="reconcillation__header__section">
              <div className="reconcillation__header__section__main">
                <h5>Company: Verka</h5>
                <h4>{`${"Agent-Wise Milk Collection Report"}`}</h4>
              </div>
