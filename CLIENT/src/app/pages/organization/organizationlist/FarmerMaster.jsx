...
const FarmerList = () => {
  ...
  GetAllFarmers(
    (res) => {
      ...
      if (status === 200) {
        // data is already an array of farmers
        setOrganizationTableData(data);
        setFilteredData(data);
        setTotalRecordsCount(data.length);   // simple count
        setTotalPagesCount(1);              // or compute if you page client‑side
        setIsLoading(false);
      } else if (status === 403) {
        // ...
      } else if (status === 500) {
    ...
    <>
      {token ? (
        <div className="farmer">
          <div className="farmer__container">
            <div className="farmer__header">
              <div className="farmer__header__section">
                <div className="farmer__header__section__main">
                  <h5>Company: Verka</h5>
                ...
                <div className="farmer__header__section__bottom">
                  <Header />
                </div>
              </div>
            </div>
            {isCreateOrganization ? (
              ...
              <>
                <div className="farmer__table">
                  <div className="farmer__table__header">
                    <div className="farmer__table__header__section">
                      <input
                        type="text"
                  ...
                  >
                    <div className="farmer__table__pagination__container">
                      <select
                        value={newPageSize}
                        onChange={(e) =>
