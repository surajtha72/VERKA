...
import "./BmcReconcillationCycleList.scss";
    ...
    items?.push({
      ...
      heading_2: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Link
            to={isddSelected ? `/bmc-reconcillation-report` : null}
            style={{
          ...
          >
            ...
            >
              Generate BMC Reconcillation Report
            </span>
          </Link>
        </div>
      ),
    ...
    shiftWiseItems.push(
      {
        heading_2: (
          <div style={{ display: "flex", flexDirection: "column" }}>
            <Link
              to={(startDate !== null && endDate !== null && shift !== null) ? `/bmc-reconcillation-report` : null}
              style={{
          ...
          <div className="reconcillation__header">
            <div className="reconcillation__header__section">
              <div className="reconcillation__header__section__main">
                <h5>Company: Verka</h5>
                <h4>{`${"BMC Reconcillation Report"}`}</h4>
              </div>
