...
import { GetBmcReconcillation } from "../../../utils/apiCalls";
...
const ReconcillationReport = () => {
  ...
  const bmcReconRef = useRef();
  const Print = () => {
    const printContents = bmcReconRef.current?.innerHTML;
    if (printContents) {
  ...
  const handleExportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "BMCReconciliationReport.xlsx");
  };
                    ...
                    <>
                      ...
                      <>
                        {billDetails[ind].details?.map((val, ind) => {
                          if (
                            val.eveningShift?.cowMilkDetails?.avgFat +
                              val.morningShift?.cowMilkDetails?.avgFat !=
                            0
                          ) {
                            CAvgFatcounter++;
                          }
                          if (
                            val.eveningShift?.buffMilkDetails?.avgFat +
                              val.morningShift?.buffMilkDetails?.avgFat !=
                            0
                          ) {
                            BAvgFatcounter++;
                          }
                          if (
                            val.eveningShift?.cowMilkDetails?.avgSnf +
                              val.morningShift?.cowMilkDetails?.avgSnf !=
                            0
                          ) {
                            CAvgSnfcounter++;
                          }
                          if (
                            val.eveningShift?.buffMilkDetails?.avgSnf +
                              val.morningShift?.buffMilkDetails?.avgSnf !=
                            0
                          ) {
                            BAvgSnfcounter++;
                          }
                          ...
                          CWeightTotal +=
                            (val.eveningShift?.cowMilkDetails?.totalWeight ??
                              0) +
                            (val.morningShift?.cowMilkDetails?.totalWeight ??
                              0);
                          BWeightTotal +=
                            (val.eveningShift?.buffMilkDetails?.totalWeight ??
                              0) +
                            (val.morningShift?.buffMilkDetails?.totalWeight ??
                              0);
                          CAvgFatTotal +=
                            (val.eveningShift?.cowMilkDetails?.avgFat ?? 0) +
                            (val.morningShift?.cowMilkDetails?.avgFat ?? 0);
                          BAvgFatTotal +=
                            (val.eveningShift?.buffMilkDetails?.avgFat ?? 0) +
                            (val.morningShift?.buffMilkDetails?.avgFat ?? 0);
                          CAvgSnfTotal +=
                            (val.eveningShift?.cowMilkDetails?.avgSnf ?? 0) +
                            (val.morningShift?.cowMilkDetails?.avgSnf ?? 0);
                          BAvgSnfTotal +=
                            (val.eveningShift?.buffMilkDetails?.avgSnf ?? 0) +
                            (val.morningShift?.buffMilkDetails?.avgSnf ?? 0);
                          CkgFatTotal +=
                            (val.eveningShift?.cowMilkDetails?.kgFat ?? 0) +
                            (val.morningShift?.cowMilkDetails?.kgFat ?? 0);
                          BkgFatTotal +=
                            (val.eveningShift?.buffMilkDetails?.kgFat ?? 0) +
                            (val.morningShift?.buffMilkDetails?.kgFat ?? 0);
                          CkgSnfTotal +=
                            (val.eveningShift?.cowMilkDetails?.kgSnf ?? 0) +
                            (val.morningShift?.cowMilkDetails?.kgSnf ?? 0);
                          BkgSnfTotal +=
                            (val.eveningShift?.buffMilkDetails?.kgSnf ?? 0) +
                            (val.morningShift?.buffMilkDetails?.kgSnf ?? 0);
                          ...
                          return (
                            <>
                              ...
                              >
                                ...
                                <p>E</p>
                                <p>CM</p>
                                {val.eveningShift.cowMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.cowMilkDetails?.totalWeight?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.cowMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.cowMilkDetails?.avgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.cowMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.cowMilkDetails?.avgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.cowMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.cowMilkDetails?.kgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.cowMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.cowMilkDetails?.kgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                              ...
                              >
                                ...
                                <p></p>
                                <p>BM</p>
                                {val.eveningShift.buffMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.buffMilkDetails?.totalWeight?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.buffMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.buffMilkDetails?.avgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.buffMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.buffMilkDetails?.avgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.buffMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.buffMilkDetails?.kgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.eveningShift.buffMilkDetails ? (
                                  <p>
                                    {val.eveningShift?.buffMilkDetails?.kgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                              ...
                              <div
                                className="reconcillationReport__table__content3"
                                key={ind}
                              >
                                {/* {console.log("val-->", val)} */}
                                <p style={{ width: "15%" }}></p>
                                ...
                                <p>M</p>
                                <p>CM</p>
                                {val.morningShift.cowMilkDetails ? (
                                  <p>
                                    {val.morningShift?.cowMilkDetails?.totalWeight?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.cowMilkDetails ? (
                                  <p>
                                    {val.morningShift?.cowMilkDetails?.avgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.cowMilkDetails ? (
                                  <p>
                                    {val.morningShift?.cowMilkDetails?.avgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.cowMilkDetails ? (
                                  <p>
                                    {val.morningShift?.cowMilkDetails?.kgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.cowMilkDetails ? (
                                  <p>
                                    {val.morningShift?.cowMilkDetails?.kgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                              ...
                              <div
                                className="reconcillationReport__table__content4"
                                key={ind}
                              >
                                <p style={{ width: "15%" }}></p>
                                <p></p>
                                <p></p>
                                <p>BM</p>
                                {val.morningShift.buffMilkDetails ? (
                                  <p>
                                    {val.morningShift?.buffMilkDetails?.totalWeight?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.buffMilkDetails ? (
                                  <p>
                                    {val.morningShift?.buffMilkDetails?.avgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.buffMilkDetails ? (
                                  <p>
                                    {val.morningShift?.buffMilkDetails?.avgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.buffMilkDetails ? (
                                  <p>
                                    {val.morningShift?.buffMilkDetails?.kgFat?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.morningShift.buffMilkDetails ? (
                                  <p>
                                    {val.morningShift?.buffMilkDetails?.kgSnf?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                              ...
                              <div
                                className="reconcillationReport__table__totalCow"
                                key={ind}
                              >
                                <p>Total:</p>
                                <p style={{ width: "15%" }}></p>
                              ...
                              <div
                                className="reconcillationReport__table__totalBuffalo"
                                key={ind}
                              >
                                <p style={{ width: "15%" }}></p>
                                <p></p>
                      ...
                      <div className="reconcillationReport__table__belowcontent1">
                        ...
                        <p>
                          {(CAvgFatAgentTotal / CAvgFatcounter)?.toFixed(2)}
                        </p>
                        <p>
                          {(CAvgSnfAgentTotal / CAvgSnfcounter)?.toFixed(2)}
                        </p>
                      ...
                      <div className="reconcillationReport__table__belowcontent2">
                        ...
                        <p>
                          {(BAvgFatAgentTotal / BAvgFatcounter)?.toFixed(2)}
                        </p>
                        <p>
                          {(BAvgSnfAgentTotal / BAvgSnfcounter)?.toFixed(2)}
                        </p>
