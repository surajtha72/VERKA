...
import "./AgentMilkCollectionReport.scss";
import { GetAgentMilkCollection } from "../../../utils/apiCalls";
...
const AgentReconcillationReport = () => {
  ...
  const handleCycle = () => {
    navigate("/agent-cycle-list-collection");
  };
  ...
  const agentCollRef = useRef();
  const Print = () => {
    const printContents = agentCollRef.current?.innerHTML;
    if (printContents) {
  ...
  const handleExportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "AgentMilkCollectionReport.xlsx");
  };
              ...
              <div className="reconcillationReport">
                <div className="reconcillationReport__header">
                  ...
                  <div className="reconcillationReport__header__bottomheading">
                    <p>
                      Fat, SNF Agent Wise Milk Collection Sheet &nbsp;
                      From&nbsp;&nbsp;{startDt}
                      &nbsp;&nbsp;To&nbsp;&nbsp;{endDt} &nbsp;&nbsp;
                    </p>
                    {/* <p>Page No. 1</p> */}
                ...
                <div className="reconcillationReport__table__header">
                  <p style={{ width: "15%" }}>Agent Code</p>
                  <p style={{ width: "50%" }}>Agent Name</p>
                  <p>Milk Type</p>
                  <p>Qty in Kg.</p>
                  <p>Avg Fat</p>
                  <p>Avg SNF</p>
                  ...
                  return (
                    <>
                          ...
                          return (
                            <>
                              ...
                              >
                                {/* {console.log("val-->", val)} */}
                                <p style={{ width: "15%" }}>
                                  {val.agentDetail?.agentId
                                    ?.toString()
                                    .substr(-3)}
                                </p>
                                <p style={{ width: "50%" }}>
                                  {val.agentDetail?.agentName}
                                </p>
                                <p>CM</p>
                                {val.cowMilkDetail ? (
                                  <p>
                                    {val.cowMilkDetail?.totalWeight?.toFixed(2)}
                                  </p>
                                ) : (
                                  <p></p>
                                )}
                              ...
                              >
                                ...
                                {val.buffMilkDetail ? (
                                  <p>
                                    {val.buffMilkDetail?.totalWeight?.toFixed(
                                      2
                                    )}
                                  </p>
                                ) : (
                                ...
                                {val.buffMilkDetail ? (
                                  <p>
                                    {val.buffMilkDetail?.avgFat?.toFixed(2)}
                                  </p>
                                ) : (
                                  <p></p>
                                )}
                                {val.buffMilkDetail ? (
                                  <p>
                                    {val.buffMilkDetail?.avgSnf?.toFixed(2)}
                                  </p>
                                ) : (
                                  <p></p>
                                )}
                      ...
                      <div className="reconcillationReport__table__belowcontent3">
                        ...
                        <p></p>
                        <p>
                          {(CWeightAgentTotal + BWeightAgentTotal).toFixed(2)}
                        </p>
                        <p style={{ width: "50%" }}></p>
                        <p>
                          {(CkgFatAgentTotal + BkgFatAgentTotal)?.toFixed(2)}
                        </p>
                        <p>
                          {(CkgSnfAgentTotal + BkgSnfAgentTotal)?.toFixed(2)}
                        </p>
                      </div>
                    </>
                  );
