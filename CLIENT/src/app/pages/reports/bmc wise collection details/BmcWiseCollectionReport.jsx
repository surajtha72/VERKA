...
import "./BmcWiseCollectionReport.scss";
import { GetBmcWiseCollection } from "../../../utils/apiCalls";
...
const AgentReconcillationReport = () => {
  ...
  const handleCycle = () => {
    navigate("/bmc-collection-cycle-list");
  };
  ...
  const generatePDF = () => {
    ...
    const html2pdfOptions = {
      margin: 10,
      filename: "agent reconcillation report",
  ...
  const bmcCollRef = useRef();
  const Print = () => {
    const printContents = bmcCollRef.current?.innerHTML;
    if (printContents) {
  ...
  const handleExportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "BMCMilkCollectionReport.xlsx");
      };
              ...
              <div className="reconcillationReport">
                <div className="reconcillationReport__header">
                  ...
                  <div className="reconcillationReport__header__bottomheading">
                    <p>
                      Fat, SNF BMC Wise Milk Collection Sheet &nbsp;
                      From&nbsp;&nbsp;{startDt}
                      &nbsp;&nbsp;To&nbsp;&nbsp;{endDt} &nbsp;&nbsp;
                    </p>
                    {/* <p>Page No. 1</p> */}
                ...
                {billDetails.map((val, ind) => {
                  ...
                  CWeightAgentTotal += CWeightTotal;
                  BWeightAgentTotal += BWeightTotal;
                  CAvgFatAgentTotal += CAvgFatTotal;
                  BAvgFatAgentTotal += BAvgFatTotal;
                  CAvgSnfAgentTotal += CAvgSnfTotal;
                  BAvgSnfAgentTotal += BAvgSnfTotal;
                  CkgFatAgentTotal += CkgFatTotal;
                  BkgFatAgentTotal += BkgFatTotal;
                  CkgSnfAgentTotal += CkgSnfTotal;
                  BkgSnfAgentTotal += BkgSnfTotal;

                  BMCMWeightTotal += CWeightAgentTotal + BWeightAgentTotal;
                  BMCMKgFatTotal += CkgFatAgentTotal + BkgFatAgentTotal;
                  BMCMKgSnfTotal += CkgSnfAgentTotal + BkgSnfAgentTotal;

                  grandWeightTotal += CWeightAgentTotal + BWeightAgentTotal;
                  grandKgFatTotal += CkgFatAgentTotal + BkgFatAgentTotal;
                  grandKgSnfTotal += CkgSnfAgentTotal + BkgSnfAgentTotal;

                  // { console.log('BMCMWeightTotal', BMCMWeightTotal) };

                  return (
                    <>
                      <div className="reconcillationReport__table__bottomheader"></div>
                      <>
                        <div
                        ...
                        >
                          ...
                          <p>CM</p>
                          {val.cowMilkDetail ? (
                            <p>{val.cowMilkDetail?.totalWeight?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.cowMilkDetail ? (
                            <p>{val.cowMilkDetail?.avgFat?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.cowMilkDetail ? (
                            <p>{val.cowMilkDetail?.avgSnf?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.cowMilkDetail ? (
                            <p>{val.cowMilkDetail?.kgFat?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.cowMilkDetail ? (
                            <p>{val.cowMilkDetail?.kgSnf?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                        </div>
                        ...
                        >
                          ...
                          <p>BM</p>
                          {val.buffMilkDetail ? (
                            <p>{val.buffMilkDetail?.totalWeight?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.buffMilkDetail ? (
                            <p>{val.buffMilkDetail?.avgFat?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.buffMilkDetail ? (
                            <p>{val.buffMilkDetail?.avgSnf?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.buffMilkDetail ? (
                            <p>{val.buffMilkDetail?.kgFat?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                          {val.buffMilkDetail ? (
                            <p>{val.buffMilkDetail?.kgSnf?.toFixed(2)}</p>
                          ) : (
                            <p></p>
                          )}
                        </div>
...
export default AgentReconcillationReport;
