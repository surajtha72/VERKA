...
import "./AgentWiseReconcillationCycleList.scss";
    ...
    items?.push({
      ...
      heading_3: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Link
            to={isddSelected ? `/agent-reconcillation-report` : null}
            style={{
          ...
          >
            ...
            >
              Generate Agent-Wise Reconcillation Report
            </span>
          </Link>
        </div>
      ),
    ...
    shiftWiseItems.push({
      heading_2: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Link
            to={
              startDate !== null && endDate !== null && shift !== null
                ? `/bmc-collection-report`
                : null
            }
            style={{
              color:
          ...
          <div className="reconcillation__container">
            <div className="reconcillation__header">
              <div className="reconcillation__header__section">
                <div className="reconcillation__header__section__main">
                  <h5>Company: Verka</h5>
                  <h4>{`${"Agent-Wise Reconcillation Report"}`}</h4>
                </div>
            ...
            <div className="reconcillation__table">
              {isCycleWise ? (
                <button
                  onClick={() => {
                    setisCycleWise(isCycleWise ? false : true);
                  }}
                  className="buttons"
                >
                  Get Cycle-Wise Reports
                </button>
              ) : (
                <button
                  onClick={() => {
