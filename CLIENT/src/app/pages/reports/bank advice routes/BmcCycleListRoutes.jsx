...
import "./BmcCycleListRoutes.scss";
    ...
    items?.push({
      ...
      heading_3: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Link
            to={isddSelected ? `/bmc-wise-bank-advice-routes` : null}
            style={{
          ...
          >
            ...
            >
              Generate Bank Advice with Routes
            </span>
          </Link>
        </div>
      ),
...
export default BmcCycleListRoutes;
